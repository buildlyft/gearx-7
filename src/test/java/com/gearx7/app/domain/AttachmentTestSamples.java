...
public class AttachmentTestSamples {
    ...
    public static Attachment getAttachmentSample1() {
        return new Attachment().id(1L).fileName("fileName1").fileType("fileType1").fileUrl("fileUrl1");
    }

    public static Attachment getAttachmentSample2() {
        return new Attachment().id(2L).fileName("fileName2").fileType("fileType2").fileUrl("fileUrl2");
    }
