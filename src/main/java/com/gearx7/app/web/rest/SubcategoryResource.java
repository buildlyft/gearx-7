...
/**
 * REST controller for managing {@link com.gearx7.app.domain.Subcategory}.
 */
@RestController
...
public class SubcategoryResource {
    ...
    public ResponseEntity<Subcategory> updateSubcategory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subcategory.getId().toString()))
            .body(result);
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Subcategory>> getAllSubcategories(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
